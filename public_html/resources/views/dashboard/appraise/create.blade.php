    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header mb-2" style="    display: flex;justify-content: space-between;">
          <span>Agregar Avaluo</span>
          <a href="/dashboard/avaluos" class="btn btn-primary btn-sm">Volver a lista de avaluos...</a>
        </div>
        <div class="card-body">

          <form method="POST" action="/dashboard/avaluos" enctype="multipart/form-data">
            @csrf

            <div class="form-group">
              <label>Nombre</label>
              <input type="text" name="name" placeholder="Nombre de Avaluo" class="form-control mb-2" required=""
                {{ old('name') }} />
            </div>
