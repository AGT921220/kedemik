                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="/dashboard/clientes" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Nombre</label>
                                <input type="text" name="name" placeholder="Nombre de Cliente"
                                    class="form-control mb-2" required="" {{ old('name') }} />
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="address" placeholder="Dirección de Cliente"
                              class="form-control mb-2" required="" {{ old('address') }} />
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="date" name="creation_date" class="form-control mb-2" required="" {{ old('creation_date') }} />
