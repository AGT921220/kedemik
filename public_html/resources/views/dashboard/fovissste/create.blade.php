    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header mb-2" style="    display: flex;justify-content: space-between;">
          <span>Agregar Fovissste</span>
          <a href="/dashboard/fovissste" class="btn btn-primary btn-sm">Volver a lista de fovissste...</a>
        </div>
        <div class="card-body">

          <form method="POST" action="/dashboard/fovissste" enctype="multipart/form-data">
            @csrf

            <div class="form-group">
              <label>Nombre</label>
              <input type="text" name="name" placeholder="Nombre de fovissste" class="form-control mb-2" required=""
                {{ old('name') }} />
            </div>
