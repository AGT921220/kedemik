                                ...
                                <td>
                                    ...
                                    <hr>
                                         @foreach($item->payments as $value)
                                            <p>{{$value->date_payment}} - ${{number_format($item->total/$item->total_payments)}}</p>
                                         @endforeach
                                         <hr>
                                    TOTAL ${{number_format(count($item->payments)*($item->total/$item->total_payments))}}
                                    <br>
                                    RESTANTE ${{number_format($item->total-(count($item->payments)*($item->total/$item->total_payments)))}}
